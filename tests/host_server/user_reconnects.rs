...
fn client_reconnects_to_lobby()
{
    ...
    */
    ...
    let (_, mut user2) = make_test_host_user_client_with_id(user2_id, host_user_url);
    std::thread::sleep(Duration::from_millis(15));
    host_server.update();
    std::thread::sleep(Duration::from_millis(15));
...
fn client_leaves_full_acked_pending_lobby()
{
    ...
    */
    ...
    let (_, mut user1) = make_test_host_user_client_with_id(user1_id, host_user_url);
    std::thread::sleep(Duration::from_millis(15));
    host_server.update();
    std::thread::sleep(Duration::from_millis(15));
...
fn client_reconnects_to_game()
{
    ...
    */
    ...
    hub.send(HubToHostMsg::GameOver{ id: made_lobby_id, report: GameOverReport::default() });
    std::thread::sleep(Duration::from_millis(15));
    host_server.update();
    std::thread::sleep(Duration::from_millis(15));
